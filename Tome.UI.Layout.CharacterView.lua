...
Tome.UI.Layouts.CharacterView = UI.CreateFrame("Frame", "Tome_UI_Layout_View", Tome.UI.Window)
...
Tome.UI.Layouts.CharacterView.Container = UI.CreateFrame("Frame", "Tome_UI_Layout_View_Container", Tome.UI.Layouts.CharacterView)
...
Tome.UI.Layouts.CharacterView.Flag = UI.CreateFrame("Text", "Tome_UI_Layout_View_Flag", Tome.UI.Layouts.CharacterView.Container)
...
Tome.UI.Layouts.CharacterView.InCharacter = UI.CreateFrame("Text", "Tome_UI_Layout_View_InCharacter", Tome.UI.Layouts.CharacterView.Container)
Tome.UI.Layouts.CharacterView.InCharacter:SetPoint("TOPRIGHT", Tome.UI.Layouts.CharacterView.Container, "TOPRIGHT", 0, -5)

-- Create the Name label
Tome.UI.Layouts.CharacterView.Name = UI.CreateFrame("Text", "Tome_UI_Layout_View_Name", Tome.UI.Layouts.CharacterView.Container)
Tome.UI.Layouts.CharacterView.Name:SetFontSize(22)

-- Create the Title label
Tome.UI.Layouts.CharacterView.Title = UI.CreateFrame("Text", "Tome_UI_Layout_View_Title", Tome.UI.Layouts.CharacterView.Container)
...
Tome.UI.Layouts.CharacterView.Height = UI.CreateFrame("Text", "Tome_UI_Layout_View_Height", Tome.UI.Layouts.CharacterView.Container)
Tome.UI.Layouts.CharacterView.Height:SetFontSize(13)

-- Create the Appearance label
Tome.UI.Layouts.CharacterView.Appearance = {}
Tome.UI.Layouts.CharacterView.Appearance.Label = UI.CreateFrame("Text", "Tome_UI_Layout_View_Appearance_Header", Tome.UI.Layouts.CharacterView)
...
Tome.UI.Layouts.CharacterView.History.Label = UI.CreateFrame("Text", "Tome_UI_Layout_View_History_Header", Tome.UI.Layouts.CharacterView)
...
Tome.UI.Layouts.CharacterView.Age = UI.CreateFrame("Text", "Tome_UI_Layout_View_Age", Tome.UI.Layouts.CharacterView.Container)
...
Tome.UI.Layouts.CharacterView.Weight = UI.CreateFrame("Text", "Tome_UI_Layout_View_Weight", Tome.UI.Layouts.CharacterView.Container)
